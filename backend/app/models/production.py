...
class WorkCenter(Base):
    ...
    external_capacity_slots: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    external_lead_time_hours: Mapped[float | None] = mapped_column(Float, nullable=True)
    external_vendor_name: Mapped[str | None] = mapped_column(String(120), nullable=True)
...
class ProductionOperation(Base):
    ...
    requirement_note: Mapped[str | None] = mapped_column(Text, nullable=True)
    source_row: Mapped[int] = mapped_column(Integer, nullable=False)
...
class ProductionScheduleItem(Base):
    ...
    is_external: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    external_status: Mapped[str] = mapped_column(String(30), nullable=False, default="pending")
    external_sent_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    external_returned_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    external_expected_return_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
